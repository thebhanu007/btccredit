...
//	private $private_key = 'Ae50bdeb136a01877Cbc97097F9827290DAb998353AA910FA69076816C7A2391';
//	private $public_key = '06603c4401674b88a2f235d6e0098e42cdfdce6e42718df89037208006c8da73';
private $private_key = '9bBbaa301294dAFC8eC06511d712b50119e52908fBd78d5e44d4D6B451fdc458';
private $public_key = '2f79796688e0124749d695cbac23911ed50dc3767bb315633d712ad7e2aefdee';
private $ch = null;
	...
	public function get_withdrawal_info($txid) {		
		$req = array(
			'txid' => $txid,
		);
		return $this->api_call('get_withdrawal_info', $req);
	}
	public function ConvertCoins($amount, $from, $to) {		
		$req = array(
			'amount' => $amount,
			'from' => $from,
			'to' => $to,
